...
public class UrlFormatter {
    ...
    public static URL getImageUrl(JsonNode jN, StringBuffer sB) throws MalformedURLException {

        sB.append(cleanString(jN.findValue("thumbnail").findValue("path").toString()));
        sB.append("/").append(IMAGE_SIZE_PORTRAIT_INCREDIBLE).append(IMAGE_FORMAT_JPG);
